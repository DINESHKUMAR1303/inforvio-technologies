...
const AddApplicantModal = ({ show, onHide, onSave }) => {
    ...
    return (
        <Modal show={show} onHide={onHide} centered>
            <Modal.Header closeButton className="border-0 pb-0">
                <Modal.Title className="fw-bold" style={{ color: '#1f2937' }}>Add Applicant</Modal.Title>
            </Modal.Header>
            <Modal.Body className="pt-4">
                <Form.Group>
                    <Form.Label className="text-muted mb-2">Name</Form.Label>
                    <Form.Control
                        type="text"
                        value={name}
